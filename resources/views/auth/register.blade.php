                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" id="age" type="text" name="age"
                                    value="{{ old('age') }}" required autofocus autocomplete="age" placeholder="Age"
                                    required>
                            </div><!-- end form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <select name="country" class="form-control form--control" id="country" required>
                        ...
                        <p class="font-size-14 pt-2 text-center font-weight-normal">Already have an account? <a
                                href="{{ url('/login') }}" class=" btn-link" style="color:#00ab9f; ">Login</a></p>
                        <hr class="border-top-gray my-4">
