                                    ...
                                    @foreach ($getUserAppointments as $appointment)
                                        <tr>
                                            <td style="min-width: 200px;">
                                                ...
                                                <h2><a href="profile.html">Dr {{ $appointment->user->name ?? 'Patient' }}
                                                        <span>{{ $appointment->user->email ?? 'email' }}</span></a>
                                                </h2>
                                            </td>
                                            <td>
                                                <h5 class="time-title p-0">Gender</h5>
                                                <p>{{ $appointment->user->gender ?? 'Gender' }}
                                                </p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('Patient-Reschedule', ['ref_d' => $appointment->id, 'ref_id_2' => $appointment->user->id]) }}"
                                                    class="btn btn-outline-primary take-btn">Reschedule</a>
                                                <a href="{{ route('Patient-cancelAppointment', ['ref_d' => $appointment->id, 'ref_id_2' => $appointment->user->id]) }}"
                                ...
                                <tbody>
                                    @foreach ($getUserAppointmentsAll as $appointment)
                                        <tr>
                                            <td style="min-width: 200px;">
                                                <a class="avatar" href="#"></a>
                                                <h2><a href="profile.html">{{ $appointment->user->name ?? 'Patient' }}
                                                        <span>{{ $appointment->user->email ?? 'email' }}</span></a>
                                                </h2>
                                            </td>
                                            <td>
