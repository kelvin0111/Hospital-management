                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="font-size-15">Open account for free now!</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" id="age" type="number" name="age"
                                    value="{{ old('age') }}" required autocomplete="age" placeholder="age" required>
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <select name="gender" class="form-control form--control" id="gender" required>
                                    <option value="{{ old('gender') }}" label="Gender " selected="selected">
                                        Gender</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="country" class="form-control form--control" id="country">
                                    <option value="{{ old('country') }}" label="Country" selected="selected">
                                        Select a
                                        country ... </option>
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" id="phone" type="tel" name="phone"
                                    required autocomplete="tel" placeholder="Phone Number with Country Code" required />
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <input class="form-control form--control" id="specialization" type="text"
                                    name="specialization" value="{{ old('specialization') }}" required
                                    autocomplete="specialization" placeholder="specialization" required>
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <input class="form-control form--control" id="address" type="text" name="address"
                                    value="{{ old('address') }}" required autocomplete="address" placeholder="Address"
                                    required>
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <input class="form-control form--control" id="id_number" type="text" name="id_number"
                                    value="{{ old('id_number') }}" required autocomplete="id_number"
                                    placeholder="ID Code" required>
                            </div><!-- end form-group -->
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label font-weight-normal" for="register-policy">I agree
                                        to the <a href="#" class="btn-link">privacy policy</a> and <a
                                            href="#" class="btn-link">terms of services</a></label>
                                </div>
                            </div><!-- end form-group -->

                            <button id="your-form-id" class="btn btn-primary w-100" type="submit"
                                style="background-color:#00ab9f; border:4px solid #00ab9f; ">Create an Account</button>
                        </form>

                        <p class="font-size-14 pt-2 text-center font-weight-normal">Already have an account? <a
                                href="{{ route('doctor_login') }}" class=" btn-link" style="color:#00ab9f; ">Login</a>
                        </p>
                        <hr class="border-top-gray my-4">
