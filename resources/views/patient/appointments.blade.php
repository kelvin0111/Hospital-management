        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="{{ route('Patient-add-Appointment') }}" class="btn btn btn-primary btn-rounded float-right"><i
                            class="fa fa-plus"></i> Add Appointment</a>
                    {{-- onclick="getMedicalDepertment()"  --}}
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                ...
                                @foreach ($getUserAppointments as $appointments)
                                    <tr>
                                        <td><img width="28" height="28"
                                                ...
                                                alt="">{{ $appointments->doctor->name ?? 'doctor' }}</td>
                                        <td>{{ $appointments->doctor->specialization }}</td>
